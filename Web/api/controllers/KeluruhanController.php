...
use app\models\KeluruhanSeacrh;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * KeluruhanController implements the CRUD actions for Kelurahan model.
 */
class KeluruhanController extends Controller
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $searchModel = new KeluruhanSeacrh();
